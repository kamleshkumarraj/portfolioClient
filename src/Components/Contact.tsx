...
const Contact = () => {
    ...
    return <div className="px-16 pb-[20rem] md-mx:px-8 sm-mx:px-[1.6rem] mx-20 lg-mx:mx-10 md-mx:mx-0   my-10  font-mono" id="Contact">
        <h1 className="text-4xl  sm-mx:text-3xl xs-mx:text-[2.4rem] mb-10 font-bold text-center text-white"><span className="text-primaryColor">05.&nbsp;</span>Contact</h1>
        <div data-aos="flip-left" data-aos-duration="800" className="w-[70%] lg-mx:w-full shadow-[0_0_10px_0_#64FFDA50] m-auto flex flex-col gap-6 border border-primaryColor p-8 rounded-3xl sm-mx:p-4">
            <div className=" text-3xl flex gap-2 items-center text-white font-semibold sm-mx:text-[2.4rem] xs-mx:text-[2rem]">Let's Connect<IconTopologyStar3 className="w-10 h-10 text-primaryColor sm-mx:w-7 sm-mx:h-7" /></div>
